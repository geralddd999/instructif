...
public class DataInitializer {
    ...
    private static void seedStudents() {
        UserManagementService svc = new UserManagementService();
        // Two students per level (1 through 5)
