...
public class Intervenant {
   @Id
    ...
    public Intervenant(String lastName, String firstName, String email, String password, ArrayList<Integer> level, String phoneNumber, Integer nbInterventions, Boolean available) {
